...
**At least one** case study should primarily focus on a specific **research article** from a scientific journal (e.g. [Conservation Biology](), []()). For other case studies you may use multiple, reliable sources including primary literature, gray literature (e.g. reports from government agencies or NGOs) or similar.
