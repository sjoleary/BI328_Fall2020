...
* Explain why it is so important to implement a long-term monitoring plan along with a cautionary translocation protocol by briefly outlining the limitations and potential negtative impacts of genetic rescue.
...
* Conservation implies a goal of preserving a species (population). Argue whether given this perogative genetic rescue should be considered a "conservation" strategy.
